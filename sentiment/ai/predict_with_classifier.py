...
def fastai_load_model(itos_filename, classifier_filename, num_classes):
...
def predict_input(itos_filename, trained_classifier_filename, num_classes=2):
    ...
    stoi, model = fastai_load_model(itos_filename, trained_classifier_filename, num_classes)
...
if __name__ == '__main__':
    import os
    os.chdir('/Users/vanvt/2019/learn/simple-sentiment')
    itos_filename = 'data/imdb_lm/tmp/itos.pkl'
    trained_classifier_filename = 'data/aclImdb/models/clas_2.h5'
    predict_input(itos_filename, trained_classifier_filename)